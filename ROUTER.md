...
Canonical defaults live in [`src/routing-defaults.ts`](src/routing-defaults.ts) (`DEFAULT_AUTO_ROUTER_CANDIDATES_TEXT`, ~58 candidates). `src/index.ts` imports this for bootstrap and **Reset Auto Router**.
