...
| openrouter | API key | https://openrouter.ai/api/v1 | https://openrouter.ai/api/v1/models | https://openrouter.ai/api/v1/chat/completions | OPENROUTER_API_KEY | missing | 4 | — |
...
| kilo | API key | https://api.kilo.ai/api/gateway | https://api.kilo.ai/api/gateway/models | https://api.kilo.ai/api/gateway/chat/completions | KILO_API_KEY | missing | 1 | — |
...
_Generated 2026-09-05T00:02:31.310Z._
