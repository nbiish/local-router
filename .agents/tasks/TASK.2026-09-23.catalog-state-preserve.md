...
- branch: ui/catalog-state-preserve (merged 124d465 -> main 5e4d444, --no-ff; SHAs are post-rewrite — the 2026-09-23 leak purge remapped pre-rewrite 094ee9c/8103707; worktree+branch cleaned)
