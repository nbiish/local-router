...
const CANDIDATE_DEFAULTS: Record<string, string> = {
  ...
  'nous-portal-deepseek-v4-flash': 'coding=0.85, input=0, output=0, latency=700, notes=Nous Portal deepseek/deepseek-v4-flash subscription (1M ctx)',
  'nous-portal-qwen3.7-max': 'coding=0.89, input=0, output=0, latency=900, notes=Nous Portal qwen/qwen3.7-max subscription (1M ctx)',
  'nous-portal-qwen3.7-plus': 'coding=0.86, input=0, output=0, latency=800, notes=Nous Portal qwen/qwen3.7-plus subscription (1M ctx)',
  'nous-portal-qwen3.6-plus': 'coding=0.87, input=0, output=0, latency=850, notes=Nous Portal qwen/qwen3.6-plus subscription (1M ctx, vision)',
  'nous-portal-qwen3-coder': 'coding=0.88, input=0, output=0, latency=850, notes=Nous Portal qwen/qwen3-coder subscription (1M ctx, coding)',
  'nous-portal-glm-5.1': 'coding=0.88, input=0, output=0, latency=750, notes=Nous Portal z-ai/glm-5.1 subscription',
  ...
  'nous-portal-kimi-latest': 'coding=0.88, input=0, output=0, latency=850, notes=Nous Portal ~moonshotai/kimi-latest pointer (always-latest Kimi)',
  'nous-portal-nemotron-3-ultra-550b': 'coding=0.87, input=0, output=0, latency=900, notes=Nous Portal nvidia/nemotron-3-ultra-550b-a55b subscription (1M ctx)',
  ...
  'nous-portal-step-3.5-flash': 'coding=0.83, input=0, output=0, latency=650, notes=Nous Portal stepfun/step-3.5-flash subscription (cheap, fast)',
  'nous-portal-minimax-m2.7': 'coding=0.86, input=0, output=0, latency=700, notes=Nous Portal minimax/minimax-m2.7 subscription (cheap)',
  'nous-portal-claude-opus-4.8': 'coding=0.94, input=0, output=0, latency=950, notes=Nous Portal anthropic/claude-opus-4.8 subscription (1M ctx, vision)',
  'nous-portal-claude-opus-latest': 'coding=0.94, input=0, output=0, latency=950, notes=Nous Portal ~anthropic/claude-opus-latest pointer (always-latest Claude Opus)',
  'nous-portal-claude-sonnet-latest': 'coding=0.91, input=0, output=0, latency=800, notes=Nous Portal ~anthropic/claude-sonnet-latest pointer (always-latest Claude Sonnet)',
  'nous-portal-gpt-latest': 'coding=0.93, input=0, output=0, latency=850, notes=Nous Portal ~openai/gpt-latest pointer (always-latest GPT)',
  'nous-portal-gemini-pro-latest': 'coding=0.91, input=0, output=0, latency=800, notes=Nous Portal ~google/gemini-pro-latest pointer (always-latest Gemini Pro)',
  'nous-portal-gemini-flash-latest': 'coding=0.86, input=0, output=0, latency=700, notes=Nous Portal ~google/gemini-flash-latest pointer (always-latest Gemini Flash)',
  'nous-portal-gemini-3.5-flash': 'coding=0.86, input=0, output=0, latency=700, notes=Nous Portal google/gemini-3.5-flash subscription (1M ctx, vision)',
  'nous-portal-grok-4.3': 'coding=0.88, input=0, output=0, latency=850, notes=Nous Portal x-ai/grok-4.3 subscription (1M ctx)',
