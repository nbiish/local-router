...
const CANDIDATE_DEFAULTS: Record<string, string> = {
  ...
  'cline-minimax-minimax-m3': 'coding=0.85, input=0, output=0, latency=750, notes=Cline MiniMax M3 free tier',
  'cline-xiaomi-mimo-v2.5': 'coding=0.80, input=0, output=0, latency=900, notes=Cline MiMo V2.5 free tier',
  ...
  'cline-openrouter-free': 'coding=0.80, input=0, output=0, latency=900, notes=Cline openrouter/free free tier',
  'cline-deepseek-deepseek-v4-flash': 'coding=0.84, input=0, output=0, latency=800, notes=Cline DeepSeek V4 Flash free tier',
  'cline-deepseek-deepseek-v4-pro': 'coding=0.88, input=0.5, output=1, latency=800, notes=Cline DeepSeek V4 Pro paid',
  'cline-deepseek-deepseek-chat': 'coding=0.82, input=0.5, output=1, latency=850, notes=Cline DeepSeek Chat paid',
  'cline-z-ai-glm-5.1': 'coding=0.88, input=0.5, output=1, latency=750, notes=Cline z-ai/glm-5.1 paid',
  'cline-qwen-qwen3.7-max': 'coding=0.85, input=1.25, output=3.75, latency=900, notes=Cline qwen/qwen3.7-max paid',
  'cline-minimax-minimax-m2.7': 'coding=0.81, input=0.5, output=1, latency=850, notes=Cline MiniMax M2.7 paid',
  'cline-stepfun-step-3.7-flash': 'coding=0.84, input=0.1, output=0.3, latency=700, notes=Cline Step 3.7 Flash paid',
  'cline-xiaomi-mimo-v2.5-pro': 'coding=0.84, input=0.44, output=0.88, latency=700, notes=Cline MiMo V2.5 Pro paid',
  'cline-moonshotai-kimi-k2.6': 'coding=0.86, input=0.6, output=2.5, latency=850, notes=Cline Kimi K2.6 paid',
  ...
  'kilo-deepseek-deepseek-chat': 'coding=0.82, input=0.5, output=1, latency=850, notes=Kilo DeepSeek Chat paid',
  'kilo-z-ai-glm-5.1': 'coding=0.88, input=0.5, output=1, latency=750, notes=Kilo z-ai/glm-5.1 paid',
  'kilo-qwen-qwen3.7-max': 'coding=0.85, input=1.25, output=3.75, latency=900, notes=Kilo qwen/qwen3.7-max paid',
  'kilo-minimax-minimax-m3': 'coding=0.90, input=0.3, output=1.2, latency=700, notes=Kilo MiniMax M3 paid',
  'kilo-minimax-minimax-m2.7': 'coding=0.81, input=0.5, output=1, latency=850, notes=Kilo MiniMax M2.7 paid',
  'kilo-stepfun-step-3.7-flash': 'coding=0.84, input=0.1, output=0.3, latency=700, notes=Kilo Step 3.7 Flash paid',
  'kilo-xiaomi-mimo-v2.5-pro': 'coding=0.84, input=0.44, output=0.88, latency=700, notes=Kilo MiMo V2.5 Pro paid',
  'kilo-xiaomi-mimo-v2.5': 'coding=0.80, input=0.15, output=0.29, latency=900, notes=Kilo MiMo V2.5 paid',
  'kilo-moonshotai-kimi-k2.6': 'coding=0.86, input=0.6, output=2.5, latency=850, notes=Kilo Kimi K2.6 paid',
  'kilo-openrouter-owl-alpha': 'coding=0.78, input=0, output=0, latency=900, notes=Kilo openrouter/owl-alpha free',
